...
public class FileCst {
	//------------------文件目录---------------------
		//应用目录
		public final static String DIR_APP       = AppStatus.getInstance().getAppName();
		//图库目录
		public final static String DIR_PHOTO     = "DCIM";
		//音频目录
		...
		public final static String DIR_CRASH     = DIR_APP + File.separator + "ErrorReport";
		//未知目录

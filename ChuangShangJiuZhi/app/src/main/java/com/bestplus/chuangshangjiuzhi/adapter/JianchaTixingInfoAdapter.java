 ...
 */
public class JianchaTixingInfoAdapter extends BaseAdapter {
    public final static int CHOICE_CONTROL_ITEM = 0X6000;

    private Context context;
    private List<JianchaTixingInfo> list;
    private Handler handler;

    public JianchaTixingInfoAdapter(Context context, List<JianchaTixingInfo> list, Handler handler) {
    ...
    private void setItemData(ViewHolder holder, int position) {
        ...
        holder.textView_time.setText(list.get(position).getItemJianchaBaogaoshijian());
